...
var PostlistPage = /** @class */ (function () {
    ...
    PostlistPage.prototype.ionViewDidLoad = function () {
        var _this = this;
        this.ms.getData().subscribe(function (data) { return _this.parray = data['dishes']; });
    ...
    PostlistPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavParams */], __WEBPACK_IMPORTED_MODULE_2__providers_my_service_my_service__["a" /* MyServiceProvider */]])
    ], PostlistPage);
    return PostlistPage;
}());
