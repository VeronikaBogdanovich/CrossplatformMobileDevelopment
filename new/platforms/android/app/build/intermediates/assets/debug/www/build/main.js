...
var ContactPage = /** @class */ (function () {
    function ContactPage(navCtrl, storage, alertCtrl) {
        var _this = this;
        this.navCtrl = navCtrl;
        ...
        this.states = [];
        this.ch = false;
        storage.get("rules").then(function (val) {
            if (val) {
                _this.rules = val;
            }
            else {
                _this.rules = _this.rulesStart;
                storage.set("rules", _this.rulesStart);
            }
        });
    }
    ContactPage.prototype.onViewWillLoad = function () {
        var _this = this;
        this.storage.get("rules").then(function (val) {
            if (val) {
                _this.rules = val;
            }
            else {
                _this.rules = _this.rulesStart;
                _this.storage.set("rules", _this.rulesStart);
            }
        });
    };
    ContactPage.prototype.toggleRule = function (rule) {
            ...
            buttons: [
                ...
                },
                {
                    ...
                    handler: function (data) {
                        ...
                        if (data.put) {
                            _this.rules.push([data.put, false]);
                            _this.storage.set("rules", _this.rules);
                        }
                    }
                }
            ]
    ...
    ContactPage.prototype.toggleChange = function () {
        this.ch = !this.ch;
        console.log(this.ch);
    };
    ContactPage.prototype.removeRule = function (rule) {
        this.rules.splice(this.rules.indexOf(rule), 1);
        this.storage.set("rules", this.rules);
    };
    ContactPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-contact',template:/*ion-inline-start:"/Users/veronikabogdanovich/Documents/IT/new/src/pages/contact/contact.html"*/'<ion-header>\n  <ion-navbar color="primary">\n    <ion-title>\n      Прогресс\n    </ion-title>\n    <ion-buttons end>\n      <button ion-button (click)="toggleChange()" *ngIf="!ch">\n        изменить\n      </button>\n      <button ion-button (click)="toggleChange()" *ngIf="ch">\n        готово\n      </button>\n    </ion-buttons>\n  </ion-navbar>\n</ion-header>\n\n<ion-content>\n  <ion-item *ngFor="let rule of rules">\n    <ion-label>\n      {{ rule[0] }}\n      <ion-fab right top *ngIf="ch">\n        <button ion-fab mini color="danger" class="qwer" (click)="removeRule(rule)">\n          <ion-icon name="close"></ion-icon>\n        </button>\n      </ion-fab>\n    </ion-label>\n    <ion-checkbox [checked]="rule[1]" ([ngModel])="rule[1]" (click)="toggleRule(rule)"></ion-checkbox>\n\n  </ion-item>\n\n  <ion-fab right bottom *ngIf="!ch">\n    <button ion-fab mini color="danger" (click)="add()">\n      <ion-icon name="add"></ion-icon>\n    </button>\n  </ion-fab>\n</ion-content>\n\n'/*ion-inline-end:"/Users/veronikabogdanovich/Documents/IT/new/src/pages/contact/contact.html"*/
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_reader_reader__ = __webpack_require__(257);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__providers_reader_reader__ = __webpack_require__(257);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__ionic_storage__ = __webpack_require__(255);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
